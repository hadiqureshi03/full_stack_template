  ...
  const columns: Column<PersonaleRow>[] = [
    {
      ...
      header: "Navn",
      sortable: true,
      getValue: (r) => r.user?.navn ?? "",
      render: (r) => r.user?.navn ?? "—",
    },
    {
      key: "afsnit",
      header: "Afsnit",
      ...
      render: (r) =>
        r.afsnit ? <ColorBadge farve={r.afsnit.farve} label={r.afsnit.navn} /> : "—",
    },
    {
      key: "personalegruppe",
      header: "Personalegruppe",
      sortable: true,
      getValue: (r) => r.personalegruppe?.navn ?? "",
      render: (r) => r.personalegruppe?.navn ?? "—",
    },
    {
      key: "vagtlag",
      header: "Vagtlag",
      sortable: true,
      getValue: (r) => r.vagtlag?.navn ?? "",
      render: (r) => r.vagtlag?.navn ?? "—",
    },
    {
      key: "timerPrUge",
      header: "Timer/uge",
      sortable: true,
      getValue: (r) => String(r.timerPrUge),
      render: (r) => `${r.timerPrUge} t`,
    },
    {
      key: "startdato",
      header: "Startdato",
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        ...
        <div className="w-48">
          <Input
            ...
            type="date"
            value={filterSlut}
            onChange={(e) => setFilterSlut(e.target.value)}
          />
        </div>
        <div className="w-56">
          <Input
        ...
        <div className="w-48">
          <Select
            ...
            value={filterAfsnitId}
            onValueChange={setFilterAfsnitId}
          />
        </div>
        <div className="w-48">
          <Select
            ...
            value={filterPersonalegruppeId}
            onValueChange={setFilterPersonalegruppeId}
          />
        </div>
        <div className="w-48">
          <Select
            ...
            value={filterVagtlagId}
            onValueChange={setFilterVagtlagId}
          />
        </div>
      </div>
